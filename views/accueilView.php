    ...
    <div class="container p-lg-0">
        <div class="row">
            <div class="col-12 col-md-6 no-gutters">
                ...
                <div class="col">
                    <ul>
                        <li><a href="controllers/reservationController.class.php" class="btn btn-block-link">Réservation</a></li>
        ...
        <div class="row align-items-center">
            <div class="col-12 col-md-9 col-lg-10 order-12 order-md-1 text-center text-md-left">
                <ul class="list-inline m-0">
                    ...
                    <li class="list-inline-item d-block d-md-inline-block"> <a href="controllers/reservationController.class.php">Réserver une place parkings</a> </li>
                </ul>
            </div>
